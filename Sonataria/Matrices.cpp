...
///////////////////////////////////////////////////////////////////////////////
Matrix4& Matrix4::setPerspFrustum(float fovY, float aspect, float front, float back)
{
...
///////////////////////////////////////////////////////////////////////////////
// skew with a given angle holding constant on the X-axis
///////////////////////////////////////////////////////////////////////////////
Matrix4& Matrix4::shear(float value)
{
    m[0] += m[1] * value;
    m[4] += m[5] * value;
    m[8] += m[9] * value;
